...
from pyTona.answer_funcs import feet_to_miles, hal_20, get_git_branch, get_git_url, get_other_users, get_fibonacci_seq, get_collatz_seq, scan_for_virus, get_rand_seq
...
class Interface(object):
    def __init__(self):
        ...
        self.question_answers = {
            ...
            'How many steps will the Collatz pattern take to reduce to one': QA('How many steps will the Collatz pattern take to reduce to one', get_collatz_seq),
            'How many viruses do I have': QA('How many viruses do I have', scan_for_virus),
            'How about you generate a cell long sequence of numbers between one and five': QA('How about you generate a cell long sequence of numbers between one and five', get_rand_seq)
        }
